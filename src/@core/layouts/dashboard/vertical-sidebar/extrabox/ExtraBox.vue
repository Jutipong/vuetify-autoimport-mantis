...
import avatarGroup from '@images/users/avatar-group.png'
</script>

<template>
    <v-sheet rounded="md" color="gray100" class="pa-4 ExtraBox hide-menu text-center" border>
        <div class="d-flex align-center flex-column">
            <v-img :src="avatarGroup" alt="book" height="116px" width="169px" cover />
            <div class="px-3">
                <h5 class="text-h5 mb-0 line-height-none">
                    Help?
                </h5>
