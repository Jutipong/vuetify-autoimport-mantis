...
export default {
    ...
    setup() {
        ...
        setInterval(() => {
            ...
            seconds.value = Number.parseInt(lunchTime / 1000)
            minutes.value = Number.parseInt(seconds.value / 60)
            hours.value = Number.parseInt(minutes.value / 60)
            days.value = Number.parseInt(hours.value / 24)
            years.value = Number.parseInt(days.value / 365)
        }, 1000)
            ...
            <div class="text-center">
                        ...
                        <v-col cols="3" sm="3">
                            <v-card variant="outlined" class="withbg">
                                <v-card-text class="pa-0">
                                    ...
                                    <h6 class="pa-1 bg-gray100 text-caption mb-0">
                                        day
                                    </h6>
                                </v-card-text>
                            </v-card>
                ...
                <v-row class="ma-0">
                    ...
                    <v-col cols="12" class="d-sm-flex gap-2 align-center pt-0">
                        ...
                        <v-btn color="primary" elevation="0" class="mt-4 mt-sm-0">
                            Notify Me
                        </v-btn>
                    </v-col>
                </v-row>
