    ...
    <v-row>
            ...
            <v-row>
                <v-col cols="12">
                    <UiParentCard title="Basic">
                        ...
                        <v-breadcrumbs :items="['Regular', 'Medium', 'Bold']" class="text-h6 text-lightText mb-0 pa-0" />
                    </UiParentCard>
                </v-col>
                <v-col cols="12">
        ...
        <v-col cols="12" md="6">
            <v-row>
                ...
                <v-col cols="12">
                    <UiParentCard title="Gutter Bottom">
