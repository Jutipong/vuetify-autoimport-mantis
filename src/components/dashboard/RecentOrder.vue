        ...
        <v-table class="bordered-table" hover density="comfortable">
            ...
            <tbody>
                <tr v-for="item in projects" :key="item.name">
                    ...
                    <td class="py-3">
                        <v-chip v-if="item.priority === 'rejected'" variant="text" size="small" class="px-0">
                            <v-avatar size="8" color="error" variant="flat" class="mr-2" />
                            <p class="text-h6 mb-0">
                                Rejected
                            </p>
                        </v-chip>
                        <v-chip v-else-if="item.priority === 'approved'" variant="text" size="small" class="px-0">
                            <v-avatar size="8" color="success" variant="flat" class="mr-2" />
                            <p class="text-h6 mb-0">
                                Approved
                            </p>
                        </v-chip>
                        <v-chip v-else variant="text" size="small" class="px-0">
                            <v-avatar size="8" color="warning" variant="flat" class="mr-2" />
                            <p class="text-h6 mb-0">
                                Pending
                            </p>
                        </v-chip>
