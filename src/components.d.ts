...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    LayoutsVerticalHeaderNotificationDD: typeof import('./components/layouts/vertical-header/NotificationDD.vue')['default']
    LayoutsVerticalHeaderProfileDD: typeof import('./components/layouts/vertical-header/ProfileDD.vue')['default']
    LayoutsVerticalHeaderSearchBarPanel: typeof import('./components/layouts/vertical-header/SearchBarPanel.vue')['default']
    LayoutsVerticalHeaderVerticalHeader: typeof import('./components/layouts/vertical-header/VerticalHeader.vue')['default']
